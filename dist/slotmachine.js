          ...
          _createClass(SlotMachine, [
            ...
            },
            {
              ...
              value: function _wrapTiles() {
                ...
                this._fakeFirstTile =
                  this.tiles[this.tiles.length - 1].cloneNode(true);
            ...
            },
            {
              ...
              value: function _resetPosition(margin) {
                ...
                this._changeTransform(
                  !isNaN(margin) ? margin : this.bounds.initial
                );
            ...
            },
            {
              ...
              get: function get() {
                ...
                var containerMargin = parseInt(
                  rawContainerMargin.replace(matrixRegExp, "$1"),
                  10
                );

                return (
                  Math.abs(Math.round(containerMargin / firstTileHeight)) - 1
                );
              },
            },
            {
            ...
            },
            {
              ...
              set: function set(FX_SPEED) {
                ...
                raf(function () {
                  []
                    .concat(_toConsumableArray(_this7.tiles), [
                      _this7._fakeLastTile,
                      _this7._fakeFirstTile,
                    ])
