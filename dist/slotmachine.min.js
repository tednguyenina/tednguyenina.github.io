    ...
    3: [
      function (t, i, e) {
        ...
        var r = t("./timer"),
          ...
          u = "slotMachineBlurFast",
          c = "slotMachineBlurMedium",
          l = "slotMachineBlurSlow",
          f = "slotMachineBlurTurtle",
          d = "slotMachineGradient",
          v = d,
          n =
            (n(g, [
              {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (this.container = document.createElement("div")),
                    ...
                    (this._fakeFirstTile = this.tiles[
                      this.tiles.length - 1
                    ].cloneNode(!0)),
                    ...
                    (this._fakeLastTile = this.tiles[0].cloneNode(!0)),
              ...
              },
              {
                key: "_setBounds",
                value: function () {
                  var t = this.getTileOffset(this.active),
                    i = this.getTileOffset(this.tiles.length),
                    e = this.getTileOffset(this.tiles.length);
                  this._bounds = {
                    up: {
                      key: "up",
                      initial: t,
              ...
              },
              {
                key: "getTileOffset",
                value: function (t) {
                  for (var i = 0, e = 0; e < t; e++)
                    i += this.tiles[e].offsetHeight;
              ...
              },
              {
                key: "_resetPosition",
                value: function (t) {
                  this.container.classList.toggle(h),
                    this._changeTransform(isNaN(t) ? this.bounds.initial : t),
              ...
              },
              {
                ...
                value: function (i, e) {
                  ...
                  return (
                    ...
                    (this.running = !0),
                    this.visible || !0 !== this.inViewport
                      ? ((t = this._getDelayFromSpins(i)),
                        this._changeTransition(t),
                        ...
                        o(function () {
                          ...
                          !n.stopping &&
                            n.running &&
                            ((t = i - 1),
                            n._resetPosition(n.bounds.first),
                            1 < t ? n.shuffle(t, e) : n.stop(e));
                        }, t))
                      : this.stop(e),
                    this.nextActive
                  );
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  (this.running = !0),
                    (this.stopping = !0),
                    Number.isInteger(this.nextActive) ||
                      (this.nextActive = this.custom),
                    this._isGoingBackward()
              ...
              },
              {
                ...
                value: function () {
                  var t = this;
                  this.running ||
                    (this._timer = new r(function () {
                      t.visible || !0 !== t.inViewport
                        ? t.shuffle(t.spins, function () {
                            t._timer.reset();
                          })
                        : o(function () {
                            t._timer.reset();
              ...
              },
              {
                ...
                set: function (t) {
                  ((t = Number(t)) < 0 || t >= this.tiles.length || isNaN(t)) &&
                    (t = 0),
                    (this._active = t);
                },
              },
              {
                ...
                set: function (t) {
                  this.running ||
                    (this._direction = "down" === t ? "down" : "up");
                },
              },
              {
                key: "bounds",
              ...
              },
              {
                key: "visibleTile",
                get: function () {
                  var t = this.tiles[0].offsetHeight,
                    i = this.container.style.transform || "",
                    i = parseInt(
                      i.replace(
              ...
              },
              {
                ...
                get: function () {
                  ...
                  return this.randomize
                    ? (((t = this.randomize(this.active)) < 0 ||
                        t >= this.tiles.length) &&
                        (t = 0),
                      t)
                    : this.random;
              ...
              },
              {
                ...
                get: function () {
                  var t = this.element.getBoundingClientRect(),
                    ...
                    i = t.top <= i && 0 <= t.top + t.height,
                    t = t.left <= e && 0 <= t.left + t.width;
                  return i && t;
                },
              },
              {
                  ...
                  o(function () {
                    []
                      .concat(
                        ...
                        [t._fakeLastTile, t._fakeFirstTile]
                      )
                      .forEach(function (t) {
                        t.classList.remove(u, c, l, f),
                          i !== v && t.classList.add(i);
                      }),
                      i === v
                        ? t.container.classList.remove(d)
                        : t.container.classList.add(d);
                  }, e);
                },
              },
            ]),
        ...
        function g(t, i) {
          !(function (t) {
            ...
            this.changeSettings(Object.assign({}, a, i)),
            this._setBounds(),
            this._resetPosition(),
